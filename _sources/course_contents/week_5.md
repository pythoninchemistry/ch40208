...
- [Geometry Optimisation](../geometry_optimisation/geometry_optimisation.md)
    ...
    - [The Newton-Raphson Method](../geometry_optimisation/newton_raphson_method.ipynb)
    - [Synoptic Exercise: Optimising a Lennard-Jones Potential](../geometry_optimisation/Lennard_Jones_optimisation.ipynb )
    - [Using `scipy.optimize.minimize()`](../geometry_optimisation/scipy_optimize_minimize.ipynb)
