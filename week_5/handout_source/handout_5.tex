...
\section{Problem}
Using the work of Evans\cite{Evans2001}, write a function that will rotate a diatomic molecule by a given set of Eulerian angles ($\alpha$, $\beta$, $\gamma$; see section 5.2 of the paper).
