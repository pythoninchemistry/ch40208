...
\begin{center}
	\noindent\fbox{%
		\begin{minipage}{0.9\textwidth}%
			...
			\subsubsection{Exercise}
			\begin{itemize}
				\item{Use the \texttt{or} operator to reduce the \texttt{prior\_meetings} code above to just 8 lines long. Hint: think about other operators from Table~\ref{tab:ops}.}
			\end{itemize}
		\end{minipage}
	}
\end{center}
