	...
	\noindent\fbox{%
	    \begin{minipage}{0.9\textwidth}%
	        ...
	        \begin{itemize}
	        	...
	        	\item{Determine the \emph{type} of each of the following:}
	        	\begin{enumerate}
	        		\item{\texttt{greeting = "Hello World!"}}
	        		\item{\texttt{pi = 3.1415}}
	        		\item{\texttt{life = 42}}
	        	\end{enumerate}
	        	\item{Consider the difference between \texttt{1}, \texttt{1.}, and \texttt{1.0} as interperated by Python.}
	        \end{itemize}
	    \end{minipage}
	}
\end{center}
...
Python is able to basic mathematical operations natively (without the need for additional libraries to be loaded). 
\begin{table}[h]
	\centering
